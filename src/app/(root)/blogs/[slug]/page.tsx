...
function SlugPage({ params }: { params: { slug: string } }) {
	return (
		<div className='pt-[15vh] max-w-5xl mx-auto'>
			<h1 className='lg:text-6xl md:text-5xl text-4xl font-creteRound'>The AGI hype train is running out of steam</h1>

			<div className='flex items-center flex-wrap max-md:justify-center gap-4 mt-4'>
				<div className='flex items-center gap-2'>
					<Image src={'/author/thomas-macaulay.jpg'} alt='author' width={30} height={30} className='object-cover rounded-sm' />
					<p>by Samar</p>
				</div>
				<Minus />
				<div className='flex items-center gap-2'>
			...
			<Image src={'/blogs/02.jpg'} alt='alt' width={`1120`} height={`595`} className='mt-4 rounded-md' />
			...
			<div className='flex mt-6 gap-6 items-center max-md:flex-col'>
				<Image src={'/author/chris-impey.jpg'} alt='author' width='155' height='155' className='rounded-md max-md:self-start' />
				<div className='flex-1 flex flex-col space-y-4'>
					<h2 className='text-3xl font-creteRound'>Thomas Macaulay</h2>
					<p className='line-clamp-2 text-muted-foreground'>
						Thomas Macaulay is a writer based in New York City. He is interested in all things tech, science, and photography
						related, and likes to yo-yo in
					</p>
